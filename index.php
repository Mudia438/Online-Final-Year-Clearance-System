    ...
    <div class="modal-dialog modal-lg modal-sm modal-md">
        <div class="modal-content">
            <div class="modal-header label-primary" >
                ...
                <h4 class="modal-title" style="color:WHITE;font-family:comic sans ms;font-size:25px;font-weight:bold">ABOUT THE PROJECT - ONLINE CLEARANCE SYSTEM</h4>
            </div>
            <div class="modal-body" style="font-family:comic sans ms;font-size:15px;font-weight:bold">
                <p  >Delta State School Of Marine Technology, Burutu - Delta State Nigeria.</p>
				<p >The Project Online Clearance System is Design By :</p>
				<p> Ugochukwu Samuel Osinachi - Reg No : ST/BUR/ND/15/16/1659 .</p>
				<br>
				<p >For the Partial Fulfillment of the requirement for the Award of National Diploma (ND) in Computer Science - Delta State School Of Marine Technology, Burutu - 2017</p><br>
